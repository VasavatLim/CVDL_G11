...
# hyperparameters
# ---------------------------------------------------------------------------------
# Best hyperparameters: {'model': 'CNN', 'learning_rate': 0.001291782740836211, 'batch_size': 16, 'optimizer': 'Adam', 
# 'dropout': 0.49787040260917054, 'num_filters': 32, 'weight_decay': 7.317443192410258e-05, 'scheduler': 'StepLR'}
LEARNING_RATE = 0.001
BATCH_SIZE = 32
EPOCHS = 5
IMG_SIZE = (430, 380)
